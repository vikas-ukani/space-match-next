...
const DeclinedSpacesSlider = ({ images, setting = {} }) => {
    const properties = { ...settings, ...setting }
    // <div class="space-image-item"><img src="'+new_image_path+'" class="img-fluid" alt="'+property_images[pi]['property_image_name']+'"/></div>
    return (
        <Slider {...properties}>
            {images?.map(spaceImage => {
                return (
...
export default DeclinedSpacesSlider;