const NotHappyEnquiryConfirmationPopup = () => {
    return (
        <div>
            <div className="modal hide" id="modalNotHappyConfimation">
                <div className="modal-dialog modal-dialog-centered modal-sm">
                    <div className="modal-content">
                        ...
                        <p className="text-center text-grey lead font-weight-medium">Are you sure, you are not happy with this space?</p>
                        <input type="hidden" name="enquiryId" id="enquiryId" value="" />
                    </div>

                    <div className="modal-footer border-0 justify-content-center">
                        <button type="button" className="btn btn-secondary" data-dismiss="modal">Cancel</button>
                        <button type="button" className="btn btn-danger" id="not-happy-space">Not Happy</button>
                    </div>
                </div>
            </div>
        </div>
...
export default NotHappyEnquiryConfirmationPopup;