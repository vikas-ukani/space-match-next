                                    ...
                                    <div className="col-xl-4">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" id="bankname" name="bankname"
                                                value="{{ !empty($bankDetails->bankname) ? $bankDetails->bankname : ''  }}" @if($hidden) readonly @endif />
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" id="nameaccountholder" name="nameaccountholder"
                                                value="{{ !empty($bankDetails->nameaccountholder) ? $bankDetails->nameaccountholder : ''  }}" @if($hidden) readonly @endif />
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" id="accountnumber" name="accountnumber"
                                                value="{{ !empty($bankDetails->accountnumber) ? $bankDetails->accountnumber : ''  }}" @if($hidden) readonly @endif />
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" id="branchcode" name="branchcode"
                                                value="{{ !empty($bankDetails->branchcode) ? $bankDetails->branchcode : ''  }}"
                                            // @if($hidden) readonly @endif 
                                            />
                                    ...
                                    <div className="col-xl-4">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div className="custom-file mb-3 d-flex align-items-center" id="bank_proof">
                                                ...
                                                />
                                                <label className="custom-file-label font-weight-bold" for="bankdocument">Upload</label>
