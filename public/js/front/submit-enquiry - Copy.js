	$(document).ready( function () {
        ...
        form.validate( {
			rules: {
                ...
                'enquiry_uploadimages[]': {
                    ...
                    // required: function(element) {
                    //     var uploadPhotos = '';
                    //     uploadPhotos = $("#enquiry_uploadimages").closest("div").find(".uploaded").children().length;
                    //     if(uploadPhotos == 0 )
                    //         return false;
                    //     else 
                    //         return true;
			...
			errorPlacement: function ( error, element ) {
				...
				if ( element.prop( "type" ) === "checkbox" ) {
					...
					else if ( element.prop( "name" ) === "bookingentity[]" ) {
				...
				else if ( element.prop( "name" ) === "galleryphotoadd" ) {
					error.appendTo( "#errorGalleryPhoto" );
				}
        ...
        $("#enquiry_uploadimages").change(function() {
