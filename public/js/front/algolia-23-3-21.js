...
const renderPagination = (renderOptions, isFirstRender) => {
    ...
    console.log("widgetParams1111==>"+widgetParams);
  console.log(widgetParams);
 
    const container = document.querySelector("#pagination");
    console.log("SET hitsPerPage==>" + hitsPerPage);
   // console.log("SET hitsPerPage 543435345435==>" + widgetParams.searchParameters.hitsPerPage);
    ...
    // [...container.querySelector(".pagination-maven-list")].addEventListener("click", event => { 
    //         event.preventDefault();
    //         refine(event.currentTarget.dataset.value);
...
const renderConfigure = (renderOptions, isFirstRender) => {
   // const { refine, widgetParams, nbHits } = renderOptions;
  ...
  console.log(widgetParams);
    ...
    if (isFirstRender) {
        ...
        button1.className = "custom-select pagination-maven-list"; 

      //  button1.setAttribute('id',"pagination-maven-list");
        ...
        button1.addEventListener("change", () => { 
            console.log("Test1==>"+button1.value); 
            console.log("widgetParams hitsPerPage==>"+widgetParams.searchParameters.hitsPerPage); 
            widgetParams.searchParameters.hitsPerPage = button1.value;

            console.log("widgetParams After hitsPerPage==>"+widgetParams.searchParameters.hitsPerPage); 
            refine({
                //hitsPerPage: (widgetParams.searchParameters.hitsPerPage = button1.value), 
            ...
            console.log("hitsPerPage2==>"+button1.value); 

            $('#pagination').val('TESTIIINNNNNNGGGGGGGGG');


          //  document.getElementById("pagination").innerHTML = 'NIYATI......TESTIIINNNNNNGGGGGGGGG';
        ...
        widgetParams.container.querySelector("select").innerHTML =
            "<option value='30'>30</option><option value='50'>50</option><option value='80'>80</option><option value='100'>100</option>";
    }
