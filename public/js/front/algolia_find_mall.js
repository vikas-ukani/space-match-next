...
// r = parseInt(r) * 1000; //in meters, 1000 = 1km
// r = parseInt(r); //in meters, 1000 = 1km
r = r * 1000;
...
const renderPagination = (renderOptions, isFirstRender) => {
    ...
    ${!nbHits
            ...
            ${pages
                .map(
                    page => `
                    <span class="text-right ${currentRefinement !== page ? "d-none" : ""
                        }" >
                    ${currentRefinement * hitsPerPage + 1} - ${isLastPage ? nbHits : (page + 1) * hitsPerPage
                        }  of ${nbHits}
                    </span>
                    `
                )
